...
class BusinessPartnerApi {
    ...
    _addNavigationProperties(linkedApis) {
        this.navigationPropertyFields = {
            ...
            TO_BUS_PART_ADDR_DEPDNT_TAX_NMBR: new odata_v2_1.Link('to_BusPartAddrDepdntTaxNmbr', this, linkedApis[7]),
            TO_CUSTOMER: new odata_v2_1.OneToOneLink('to_Customer', this, linkedApis[8]),
            TO_SUPPLIER: new odata_v2_1.OneToOneLink('to_Supplier', this, linkedApis[9])
        };
        return this;
    }
    requestBuilder() {

...
export class BpContactToAddressApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
    EntityApi<
      BpContactToAddress<
        DeSerializersT
      >, 
  ...
  _addNavigationProperties(
      linkedApis: [
        AddressEmailAddressApi<DeSerializersT>,AddressFaxNumberApi<DeSerializersT>,AddressPhoneNumberApi<DeSerializersT>,AddressPhoneNumberApi<DeSerializersT>,AddressHomePageUrlApi<DeSerializersT>
      ]): this {
        this.navigationPropertyFields = {
          TO_EMAIL_ADDRESS: new Link(
              'to_EmailAddress',
              this,
              linkedApis[0]
            ),
          TO_FAX_NUMBER: new Link(
              'to_FaxNumber',
              this,
              linkedApis[1]
            ),
          ...
          TO_PHONE_NUMBER: new Link(
              'to_PhoneNumber',
              this,
              linkedApis[3]
            ),
          TO_URL_ADDRESS: new Link(
              'to_URLAddress',
              this,
              linkedApis[4]
            )
  ...
  requestBuilder(): BpContactToAddressRequestBuilder<
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<typeof BpContactToAddress, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(BpContactToAddress, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    RELATIONSHIP_NUMBER: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
BUSINESS_PARTNER_COMPANY: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
BUSINESS_PARTNER_PERSON: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
VALIDITY_END_DATE: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.DateTime', false, true>,
ADDRESS_ID: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
ADDRESS_NUMBER: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ADDITIONAL_STREET_PREFIX_NAME: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ADDITIONAL_STREET_SUFFIX_NAME: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ADDRESS_TIME_ZONE: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CARE_OF_NAME: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CITY_CODE: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CITY_NAME: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
COMPANY_POSTAL_CODE: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
COUNTRY: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
COUNTY: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
DELIVERY_SERVICE_NUMBER: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
DELIVERY_SERVICE_TYPE_CODE: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
DISTRICT: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
FORM_OF_ADDRESS: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
FULL_NAME: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
HOME_CITY_NAME: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
HOUSE_NUMBER: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
HOUSE_NUMBER_SUPPLEMENT_TEXT: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
LANGUAGE: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PO_BOX: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PO_BOX_DEVIATING_CITY_NAME: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PO_BOX_DEVIATING_COUNTRY: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PO_BOX_DEVIATING_REGION: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PO_BOX_IS_WITHOUT_NUMBER: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
PO_BOX_LOBBY_NAME: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PO_BOX_POSTAL_CODE: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PERSON: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
POSTAL_CODE: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PRFRD_COMM_MEDIUM_TYPE: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
REGION: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
STREET_NAME: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
STREET_PREFIX_NAME: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
STREET_SUFFIX_NAME: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TAX_JURISDICTION: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TRANSPORT_ZONE: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ADDRESS_REPRESENTATION_CODE: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CONTACT_RELATIONSHIP_FUNCTION: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CONTACT_RELATIONSHIP_DEPARTMENT: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
FLOOR: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CONTACT_PERSON_BUILDING: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ROOM_NUMBER: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CONTACT_PERSON_PRFRD_COMM_MEDIUM: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CORRESPONDENCE_SHORT_NAME: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INHOUSE_MAIL: OrderableEdmTypeField<BpContactToAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
/**
 * Static representation of the one-to-many navigation property {@link toEmailAddress} for query construction.
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */

 ...
 */
export class BusinessPartnerAddress<T extends DeSerializers = DefaultDeSerializers> extends Entity implements BusinessPartnerAddressType<T> {
  /**
  ...
  /**
   * One-to-one navigation property to the {@link BpAddrDepdntIntlLocNumber} entity.
   */

...
export class CustomerTextApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _schema?: {
    CUSTOMER: OrderableEdmTypeField<CustomerText<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
LANGUAGE: OrderableEdmTypeField<CustomerText<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
LONG_TEXT_ID: OrderableEdmTypeField<CustomerText<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
LONG_TEXT: OrderableEdmTypeField<CustomerText<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

 ...
 */
export class CustSlsAreaAddrDepdntInfoRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<CustSlsAreaAddrDepdntInfo<T>, T> {
  /**
  ...
  getByKey(customer: DeserializedType<T, 'Edm.String'>, salesOrganization: DeserializedType<T, 'Edm.String'>, distributionChannel: DeserializedType<T, 'Edm.String'>, division: DeserializedType<T, 'Edm.String'>, addressId: DeserializedType<T, 'Edm.String'>): GetByKeyRequestBuilder<CustSlsAreaAddrDepdntInfo<T>, T> {
    return new GetByKeyRequestBuilder<CustSlsAreaAddrDepdntInfo<T>, T>(this.entityApi, {
      Customer: customer,
  ...
  getAll(): GetAllRequestBuilder<CustSlsAreaAddrDepdntInfo<T>, T> {
    return new GetAllRequestBuilder<CustSlsAreaAddrDepdntInfo<T>, T>(this.entityApi);
  }
  ...
  create(entity: CustSlsAreaAddrDepdntInfo<T>): CreateRequestBuilder<CustSlsAreaAddrDepdntInfo<T>, T> {
    return new CreateRequestBuilder<CustSlsAreaAddrDepdntInfo<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: CustSlsAreaAddrDepdntInfo<T>): UpdateRequestBuilder<CustSlsAreaAddrDepdntInfo<T>, T> {
    return new UpdateRequestBuilder<CustSlsAreaAddrDepdntInfo<T>, T>(this.entityApi, entity);
  }
  ...
  delete(customerOrEntity: any, salesOrganization?: string, distributionChannel?: string, division?: string, addressId?: string): DeleteRequestBuilder<CustSlsAreaAddrDepdntInfo<T>, T> {
    return new DeleteRequestBuilder<CustSlsAreaAddrDepdntInfo<T>, T>(this.entityApi, customerOrEntity instanceof CustSlsAreaAddrDepdntInfo ? customerOrEntity : {

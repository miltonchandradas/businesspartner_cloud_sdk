...
export class AddressEmailAddressApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof AddressEmailAddress, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(AddressEmailAddress, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    ADDRESS_ID: OrderableEdmTypeField<AddressEmailAddress<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
PERSON: OrderableEdmTypeField<AddressEmailAddress<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
ORDINAL_NUMBER: OrderableEdmTypeField<AddressEmailAddress<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
IS_DEFAULT_EMAIL_ADDRESS: OrderableEdmTypeField<AddressEmailAddress<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
EMAIL_ADDRESS: OrderableEdmTypeField<AddressEmailAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SEARCH_EMAIL_ADDRESS: OrderableEdmTypeField<AddressEmailAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ADDRESS_COMMUNICATION_REMARK_TEXT: OrderableEdmTypeField<AddressEmailAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

...
class BusinessPartnerAddressApi {
    ...
    _addNavigationProperties(linkedApis) {
        this.navigationPropertyFields = {
            ...
            TO_EMAIL_ADDRESS: new odata_v2_1.Link('to_EmailAddress', this, linkedApis[2]),
            TO_FAX_NUMBER: new odata_v2_1.Link('to_FaxNumber', this, linkedApis[3]),
            TO_MOBILE_PHONE_NUMBER: new odata_v2_1.Link('to_MobilePhoneNumber', this, linkedApis[4]),
            TO_PHONE_NUMBER: new odata_v2_1.Link('to_PhoneNumber', this, linkedApis[5]),
            TO_URL_ADDRESS: new odata_v2_1.Link('to_URLAddress', this, linkedApis[6])
        };
        return this;
    }
    requestBuilder() {

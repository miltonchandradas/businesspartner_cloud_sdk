...
export class CustAddrDepdntInformationApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
    EntityApi<
  ...
  requestBuilder(): CustAddrDepdntInformationRequestBuilder<
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<typeof CustAddrDepdntInformation, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(CustAddrDepdntInformation, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    CUSTOMER: OrderableEdmTypeField<CustAddrDepdntInformation<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
ADDRESS_ID: OrderableEdmTypeField<CustAddrDepdntInformation<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
EXPRESS_TRAIN_STATION_NAME: OrderableEdmTypeField<CustAddrDepdntInformation<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TRAIN_STATION_NAME: OrderableEdmTypeField<CustAddrDepdntInformation<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CITY_CODE: OrderableEdmTypeField<CustAddrDepdntInformation<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
COUNTY: OrderableEdmTypeField<CustAddrDepdntInformation<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

 ...
 */
export class CustUnldgPtAddrDepdntInfoRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<CustUnldgPtAddrDepdntInfo<T>, T> {
  /**
  ...
  getByKey(customer: DeserializedType<T, 'Edm.String'>, addressId: DeserializedType<T, 'Edm.String'>, unloadingPointName: DeserializedType<T, 'Edm.String'>): GetByKeyRequestBuilder<CustUnldgPtAddrDepdntInfo<T>, T> {
    return new GetByKeyRequestBuilder<CustUnldgPtAddrDepdntInfo<T>, T>(this.entityApi, {
      Customer: customer,
      AddressID: addressId,
  ...
  getAll(): GetAllRequestBuilder<CustUnldgPtAddrDepdntInfo<T>, T> {
    return new GetAllRequestBuilder<CustUnldgPtAddrDepdntInfo<T>, T>(this.entityApi);
  }
  ...
  create(entity: CustUnldgPtAddrDepdntInfo<T>): CreateRequestBuilder<CustUnldgPtAddrDepdntInfo<T>, T> {
    return new CreateRequestBuilder<CustUnldgPtAddrDepdntInfo<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: CustUnldgPtAddrDepdntInfo<T>): UpdateRequestBuilder<CustUnldgPtAddrDepdntInfo<T>, T> {
    return new UpdateRequestBuilder<CustUnldgPtAddrDepdntInfo<T>, T>(this.entityApi, entity);
  }
  ...
  delete(customerOrEntity: any, addressId?: string, unloadingPointName?: string): DeleteRequestBuilder<CustUnldgPtAddrDepdntInfo<T>, T> {
    return new DeleteRequestBuilder<CustUnldgPtAddrDepdntInfo<T>, T>(this.entityApi, customerOrEntity instanceof CustUnldgPtAddrDepdntInfo ? customerOrEntity : {

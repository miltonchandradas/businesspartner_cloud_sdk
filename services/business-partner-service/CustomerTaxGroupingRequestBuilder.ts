 ...
 */
export class CustomerTaxGroupingRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<CustomerTaxGrouping<T>, T> {
  /**
  ...
  getByKey(customer: DeserializedType<T, 'Edm.String'>, customerTaxGroupingCode: DeserializedType<T, 'Edm.String'>): GetByKeyRequestBuilder<CustomerTaxGrouping<T>, T> {
    return new GetByKeyRequestBuilder<CustomerTaxGrouping<T>, T>(this.entityApi, {
      Customer: customer,
  ...
  update(entity: CustomerTaxGrouping<T>): UpdateRequestBuilder<CustomerTaxGrouping<T>, T> {
    return new UpdateRequestBuilder<CustomerTaxGrouping<T>, T>(this.entityApi, entity);
  }
  ...
  delete(customerOrEntity: any, customerTaxGroupingCode?: string): DeleteRequestBuilder<CustomerTaxGrouping<T>, T> {
    return new DeleteRequestBuilder<CustomerTaxGrouping<T>, T>(this.entityApi, customerOrEntity instanceof CustomerTaxGrouping ? customerOrEntity : {

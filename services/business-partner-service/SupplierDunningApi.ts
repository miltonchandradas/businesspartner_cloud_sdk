...
export class SupplierDunningApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
    EntityApi<
      SupplierDunning<
        DeSerializersT
      >, 
  ...
  requestBuilder(): SupplierDunningRequestBuilder<
    DeSerializersT
  > {
  ...
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(SupplierDunning, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    SUPPLIER: OrderableEdmTypeField<SupplierDunning<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
COMPANY_CODE: OrderableEdmTypeField<SupplierDunning<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
DUNNING_AREA: OrderableEdmTypeField<SupplierDunning<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
DUNNING_BLOCK: OrderableEdmTypeField<SupplierDunning<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
DUNNING_LEVEL: OrderableEdmTypeField<SupplierDunning<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
DUNNING_PROCEDURE: OrderableEdmTypeField<SupplierDunning<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
DUNNING_RECIPIENT: OrderableEdmTypeField<SupplierDunning<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
LAST_DUNNED_ON: OrderableEdmTypeField<SupplierDunning<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
LEG_DUNNING_PROCEDURE_ON: OrderableEdmTypeField<SupplierDunning<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
DUNNING_CLERK: OrderableEdmTypeField<SupplierDunning<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
AUTHORIZATION_GROUP: OrderableEdmTypeField<SupplierDunning<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SUPPLIER_ACCOUNT_GROUP: OrderableEdmTypeField<SupplierDunning<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

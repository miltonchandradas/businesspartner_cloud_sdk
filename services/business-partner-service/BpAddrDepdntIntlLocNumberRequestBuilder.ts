 ...
 */
export class BpAddrDepdntIntlLocNumberRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<BpAddrDepdntIntlLocNumber<T>, T> {
  /**
  ...
  getByKey(businessPartner: DeserializedType<T, 'Edm.String'>, addressId: DeserializedType<T, 'Edm.String'>): GetByKeyRequestBuilder<BpAddrDepdntIntlLocNumber<T>, T> {
    return new GetByKeyRequestBuilder<BpAddrDepdntIntlLocNumber<T>, T>(this.entityApi, {
  ...
  getAll(): GetAllRequestBuilder<BpAddrDepdntIntlLocNumber<T>, T> {
    return new GetAllRequestBuilder<BpAddrDepdntIntlLocNumber<T>, T>(this.entityApi);
  }
  ...
  create(entity: BpAddrDepdntIntlLocNumber<T>): CreateRequestBuilder<BpAddrDepdntIntlLocNumber<T>, T> {
    return new CreateRequestBuilder<BpAddrDepdntIntlLocNumber<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: BpAddrDepdntIntlLocNumber<T>): UpdateRequestBuilder<BpAddrDepdntIntlLocNumber<T>, T> {
    return new UpdateRequestBuilder<BpAddrDepdntIntlLocNumber<T>, T>(this.entityApi, entity);
  }
  ...
  delete(businessPartnerOrEntity: any, addressId?: string): DeleteRequestBuilder<BpAddrDepdntIntlLocNumber<T>, T> {
    return new DeleteRequestBuilder<BpAddrDepdntIntlLocNumber<T>, T>(this.entityApi, businessPartnerOrEntity instanceof BpAddrDepdntIntlLocNumber ? businessPartnerOrEntity : {

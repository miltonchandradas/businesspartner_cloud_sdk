...
export class SupplierCompanyTextApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof SupplierCompanyText, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(SupplierCompanyText, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    SUPPLIER: OrderableEdmTypeField<SupplierCompanyText<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
COMPANY_CODE: OrderableEdmTypeField<SupplierCompanyText<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
LANGUAGE: OrderableEdmTypeField<SupplierCompanyText<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
LONG_TEXT_ID: OrderableEdmTypeField<SupplierCompanyText<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
LONG_TEXT: OrderableEdmTypeField<SupplierCompanyText<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

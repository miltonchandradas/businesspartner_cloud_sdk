 ...
 */
export class CustSlsAreaAddrDepdntTaxInfoRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<CustSlsAreaAddrDepdntTaxInfo<T>, T> {
  /**
  ...
  getByKey(customer: DeserializedType<T, 'Edm.String'>, salesOrganization: DeserializedType<T, 'Edm.String'>, distributionChannel: DeserializedType<T, 'Edm.String'>, division: DeserializedType<T, 'Edm.String'>, addressId: DeserializedType<T, 'Edm.String'>, departureCountry: DeserializedType<T, 'Edm.String'>, customerTaxCategory: DeserializedType<T, 'Edm.String'>): GetByKeyRequestBuilder<CustSlsAreaAddrDepdntTaxInfo<T>, T> {
    return new GetByKeyRequestBuilder<CustSlsAreaAddrDepdntTaxInfo<T>, T>(this.entityApi, {
      Customer: customer,
  ...
  getAll(): GetAllRequestBuilder<CustSlsAreaAddrDepdntTaxInfo<T>, T> {
    return new GetAllRequestBuilder<CustSlsAreaAddrDepdntTaxInfo<T>, T>(this.entityApi);
  }
  ...
  create(entity: CustSlsAreaAddrDepdntTaxInfo<T>): CreateRequestBuilder<CustSlsAreaAddrDepdntTaxInfo<T>, T> {
    return new CreateRequestBuilder<CustSlsAreaAddrDepdntTaxInfo<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: CustSlsAreaAddrDepdntTaxInfo<T>): UpdateRequestBuilder<CustSlsAreaAddrDepdntTaxInfo<T>, T> {
    return new UpdateRequestBuilder<CustSlsAreaAddrDepdntTaxInfo<T>, T>(this.entityApi, entity);
  }
  ...
  delete(customerOrEntity: any, salesOrganization?: string, distributionChannel?: string, division?: string, addressId?: string, departureCountry?: string, customerTaxCategory?: string): DeleteRequestBuilder<CustSlsAreaAddrDepdntTaxInfo<T>, T> {
    return new DeleteRequestBuilder<CustSlsAreaAddrDepdntTaxInfo<T>, T>(this.entityApi, customerOrEntity instanceof CustSlsAreaAddrDepdntTaxInfo ? customerOrEntity : {

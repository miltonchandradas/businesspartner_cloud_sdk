 ...
 */
export class BusPartAddrDepdntTaxNmbrRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<BusPartAddrDepdntTaxNmbr<T>, T> {
  /**
  ...
  getByKey(businessPartner: DeserializedType<T, 'Edm.String'>, addressId: DeserializedType<T, 'Edm.String'>, bpTaxType: DeserializedType<T, 'Edm.String'>): GetByKeyRequestBuilder<BusPartAddrDepdntTaxNmbr<T>, T> {
    return new GetByKeyRequestBuilder<BusPartAddrDepdntTaxNmbr<T>, T>(this.entityApi, {
  ...
  getAll(): GetAllRequestBuilder<BusPartAddrDepdntTaxNmbr<T>, T> {
    return new GetAllRequestBuilder<BusPartAddrDepdntTaxNmbr<T>, T>(this.entityApi);
  }
  ...
  create(entity: BusPartAddrDepdntTaxNmbr<T>): CreateRequestBuilder<BusPartAddrDepdntTaxNmbr<T>, T> {
    return new CreateRequestBuilder<BusPartAddrDepdntTaxNmbr<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: BusPartAddrDepdntTaxNmbr<T>): UpdateRequestBuilder<BusPartAddrDepdntTaxNmbr<T>, T> {
    return new UpdateRequestBuilder<BusPartAddrDepdntTaxNmbr<T>, T>(this.entityApi, entity);
  }
  ...
  delete(businessPartnerOrEntity: any, addressId?: string, bpTaxType?: string): DeleteRequestBuilder<BusPartAddrDepdntTaxNmbr<T>, T> {
    return new DeleteRequestBuilder<BusPartAddrDepdntTaxNmbr<T>, T>(this.entityApi, businessPartnerOrEntity instanceof BusPartAddrDepdntTaxNmbr ? businessPartnerOrEntity : {

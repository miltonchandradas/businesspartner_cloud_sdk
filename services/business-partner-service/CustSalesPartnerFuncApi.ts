...
export class CustSalesPartnerFuncApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof CustSalesPartnerFunc, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(CustSalesPartnerFunc, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    CUSTOMER: OrderableEdmTypeField<CustSalesPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
SALES_ORGANIZATION: OrderableEdmTypeField<CustSalesPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
DISTRIBUTION_CHANNEL: OrderableEdmTypeField<CustSalesPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
DIVISION: OrderableEdmTypeField<CustSalesPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
PARTNER_COUNTER: OrderableEdmTypeField<CustSalesPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
PARTNER_FUNCTION: OrderableEdmTypeField<CustSalesPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
BP_CUSTOMER_NUMBER: OrderableEdmTypeField<CustSalesPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CUSTOMER_PARTNER_DESCRIPTION: OrderableEdmTypeField<CustSalesPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
DEFAULT_PARTNER: OrderableEdmTypeField<CustSalesPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
SUPPLIER: OrderableEdmTypeField<CustSalesPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PERSONNEL_NUMBER: OrderableEdmTypeField<CustSalesPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CONTACT_PERSON: OrderableEdmTypeField<CustSalesPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ADDRESS_ID: OrderableEdmTypeField<CustSalesPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
AUTHORIZATION_GROUP: OrderableEdmTypeField<CustSalesPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

...
export class BpAddrDepdntIntlLocNumberApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
    EntityApi<
  ...
  requestBuilder(): BpAddrDepdntIntlLocNumberRequestBuilder<
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<typeof BpAddrDepdntIntlLocNumber, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(BpAddrDepdntIntlLocNumber, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    BUSINESS_PARTNER: OrderableEdmTypeField<BpAddrDepdntIntlLocNumber<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
ADDRESS_ID: OrderableEdmTypeField<BpAddrDepdntIntlLocNumber<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
INTERNATIONAL_LOCATION_NUMBER_1: OrderableEdmTypeField<BpAddrDepdntIntlLocNumber<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INTERNATIONAL_LOCATION_NUMBER_2: OrderableEdmTypeField<BpAddrDepdntIntlLocNumber<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INTERNATIONAL_LOCATION_NUMBER_3: OrderableEdmTypeField<BpAddrDepdntIntlLocNumber<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

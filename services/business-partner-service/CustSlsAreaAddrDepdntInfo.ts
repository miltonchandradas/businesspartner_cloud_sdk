 ...
 */
export class CustSlsAreaAddrDepdntInfo<T extends DeSerializers = DefaultDeSerializers> extends Entity implements CustSlsAreaAddrDepdntInfoType<T> {
  /**
   ...
   */
  static _keys = ['Customer', 'SalesOrganization', 'DistributionChannel', 'Division', 'AddressID'];
  /**
   * Customer Number.
   * Maximum length: 10.
   */

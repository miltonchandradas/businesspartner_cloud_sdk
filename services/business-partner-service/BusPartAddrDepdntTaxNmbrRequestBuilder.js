...
class BusPartAddrDepdntTaxNmbrRequestBuilder extends odata_v2_1.RequestBuilder {
    ...
    delete(businessPartnerOrEntity, addressId, bpTaxType) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, businessPartnerOrEntity instanceof BusPartAddrDepdntTaxNmbr_1.BusPartAddrDepdntTaxNmbr ? businessPartnerOrEntity : {

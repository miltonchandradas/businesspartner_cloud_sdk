...
export class BusPartAddrDepdntTaxNmbrApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
    EntityApi<
  ...
  requestBuilder(): BusPartAddrDepdntTaxNmbrRequestBuilder<
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<typeof BusPartAddrDepdntTaxNmbr, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(BusPartAddrDepdntTaxNmbr, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    BUSINESS_PARTNER: OrderableEdmTypeField<BusPartAddrDepdntTaxNmbr<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
ADDRESS_ID: OrderableEdmTypeField<BusPartAddrDepdntTaxNmbr<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
BP_TAX_TYPE: OrderableEdmTypeField<BusPartAddrDepdntTaxNmbr<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
BP_TAX_NUMBER: OrderableEdmTypeField<BusPartAddrDepdntTaxNmbr<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BP_TAX_LONG_NUMBER: OrderableEdmTypeField<BusPartAddrDepdntTaxNmbr<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
AUTHORIZATION_GROUP: OrderableEdmTypeField<BusPartAddrDepdntTaxNmbr<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

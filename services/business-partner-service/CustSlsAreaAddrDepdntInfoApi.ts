...
export class CustSlsAreaAddrDepdntInfoApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
    EntityApi<
  ...
  requestBuilder(): CustSlsAreaAddrDepdntInfoRequestBuilder<
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<typeof CustSlsAreaAddrDepdntInfo, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(CustSlsAreaAddrDepdntInfo, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    CUSTOMER: OrderableEdmTypeField<CustSlsAreaAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
SALES_ORGANIZATION: OrderableEdmTypeField<CustSlsAreaAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
DISTRIBUTION_CHANNEL: OrderableEdmTypeField<CustSlsAreaAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
DIVISION: OrderableEdmTypeField<CustSlsAreaAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
ADDRESS_ID: OrderableEdmTypeField<CustSlsAreaAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
INCOTERMS_CLASSIFICATION: OrderableEdmTypeField<CustSlsAreaAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INCOTERMS_LOCATION_1: OrderableEdmTypeField<CustSlsAreaAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INCOTERMS_LOCATION_2: OrderableEdmTypeField<CustSlsAreaAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
DELIVERY_IS_BLOCKED: OrderableEdmTypeField<CustSlsAreaAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SALES_OFFICE: OrderableEdmTypeField<CustSlsAreaAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SALES_GROUP: OrderableEdmTypeField<CustSlsAreaAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SHIPPING_CONDITION: OrderableEdmTypeField<CustSlsAreaAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SUPPLYING_PLANT: OrderableEdmTypeField<CustSlsAreaAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INCOTERMS_VERSION: OrderableEdmTypeField<CustSlsAreaAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

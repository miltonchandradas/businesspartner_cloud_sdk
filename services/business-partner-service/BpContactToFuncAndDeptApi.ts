...
export class BpContactToFuncAndDeptApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof BpContactToFuncAndDept, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(BpContactToFuncAndDept, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    RELATIONSHIP_NUMBER: OrderableEdmTypeField<BpContactToFuncAndDept<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
BUSINESS_PARTNER_COMPANY: OrderableEdmTypeField<BpContactToFuncAndDept<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
BUSINESS_PARTNER_PERSON: OrderableEdmTypeField<BpContactToFuncAndDept<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
VALIDITY_END_DATE: OrderableEdmTypeField<BpContactToFuncAndDept<DeSerializers>, DeSerializersT, 'Edm.DateTime', false, true>,
CONTACT_PERSON_FUNCTION: OrderableEdmTypeField<BpContactToFuncAndDept<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CONTACT_PERSON_DEPARTMENT: OrderableEdmTypeField<BpContactToFuncAndDept<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PHONE_NUMBER: OrderableEdmTypeField<BpContactToFuncAndDept<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PHONE_NUMBER_EXTENSION: OrderableEdmTypeField<BpContactToFuncAndDept<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
FAX_NUMBER: OrderableEdmTypeField<BpContactToFuncAndDept<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
FAX_NUMBER_EXTENSION: OrderableEdmTypeField<BpContactToFuncAndDept<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
EMAIL_ADDRESS: OrderableEdmTypeField<BpContactToFuncAndDept<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
RELATIONSHIP_CATEGORY: OrderableEdmTypeField<BpContactToFuncAndDept<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

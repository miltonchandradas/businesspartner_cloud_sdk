 ...
 */
export class CustSlsAreaAddrDepdntTaxInfo<T extends DeSerializers = DefaultDeSerializers> extends Entity implements CustSlsAreaAddrDepdntTaxInfoType<T> {
  /**
   ...
   */
  static _keys = ['Customer', 'SalesOrganization', 'DistributionChannel', 'Division', 'AddressID', 'DepartureCountry', 'CustomerTaxCategory'];
  /**
   * Customer Number.
   * Maximum length: 10.
   */

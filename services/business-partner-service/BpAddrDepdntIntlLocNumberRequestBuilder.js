...
class BpAddrDepdntIntlLocNumberRequestBuilder extends odata_v2_1.RequestBuilder {
    ...
    delete(businessPartnerOrEntity, addressId) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, businessPartnerOrEntity instanceof BpAddrDepdntIntlLocNumber_1.BpAddrDepdntIntlLocNumber ? businessPartnerOrEntity : {

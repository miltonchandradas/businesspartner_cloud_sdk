...
export class CustUnldgPtAddrDepdntInfoApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
    EntityApi<
  ...
  entityConstructor = CustUnldgPtAddrDepdntInfo;
  
  requestBuilder(): CustUnldgPtAddrDepdntInfoRequestBuilder<
    DeSerializersT
  > {
    return new CustUnldgPtAddrDepdntInfoRequestBuilder<DeSerializersT>(this);
  }
  ...
  private _fieldBuilder?: FieldBuilder<typeof CustUnldgPtAddrDepdntInfo, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(CustUnldgPtAddrDepdntInfo, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    CUSTOMER: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
ADDRESS_ID: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
UNLOADING_POINT_NAME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
CUSTOMER_FACTORY_CALENDER_CODE: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BP_GOODS_RECEIVING_HOURS_CODE: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
IS_DFLT_BP_UNLOADING_POINT: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
MONDAY_MORNING_OPENING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
MONDAY_MORNING_CLOSING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
MONDAY_AFTERNOON_OPENING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
MONDAY_AFTERNOON_CLOSING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
TUESDAY_MORNING_OPENING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
TUESDAY_MORNING_CLOSING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
TUESDAY_AFTERNOON_OPENING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
TUESDAY_AFTERNOON_CLOSING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
WEDNESDAY_MORNING_OPENING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
WEDNESDAY_MORNING_CLOSING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
WEDNESDAY_AFTERNOON_OPENING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
WEDNESDAY_AFTERNOON_CLOSING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
THURSDAY_MORNING_OPENING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
THURSDAY_MORNING_CLOSING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
THURSDAY_AFTERNOON_OPENING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
THURSDAY_AFTERNOON_CLOSING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
FRIDAY_MORNING_OPENING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
FRIDAY_MORNING_CLOSING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
FRIDAY_AFTERNOON_OPENING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
FRIDAY_AFTERNOON_CLOSING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
SATURDAY_MORNING_OPENING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
SATURDAY_MORNING_CLOSING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
SATURDAY_AFTERNOON_OPENING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
SATURDAY_AFTERNOON_CLOSING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
SUNDAY_MORNING_OPENING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
SUNDAY_MORNING_CLOSING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
SUNDAY_AFTERNOON_OPENING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
SUNDAY_AFTERNOON_CLOSING_TIME: OrderableEdmTypeField<CustUnldgPtAddrDepdntInfo<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
ALL_FIELDS: AllFields<CustUnldgPtAddrDepdntInfo<DeSerializers>>
  };
 ...
 * All fields selector.
 */
ALL_FIELDS: new AllFields('*', CustUnldgPtAddrDepdntInfo) 
  };
    }

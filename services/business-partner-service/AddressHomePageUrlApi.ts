...
export class AddressHomePageUrlApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof AddressHomePageUrl, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(AddressHomePageUrl, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    ADDRESS_ID: OrderableEdmTypeField<AddressHomePageUrl<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
PERSON: OrderableEdmTypeField<AddressHomePageUrl<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
ORDINAL_NUMBER: OrderableEdmTypeField<AddressHomePageUrl<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
VALIDITY_START_DATE: OrderableEdmTypeField<AddressHomePageUrl<DeSerializers>, DeSerializersT, 'Edm.DateTime', false, true>,
IS_DEFAULT_URL_ADDRESS: OrderableEdmTypeField<AddressHomePageUrl<DeSerializers>, DeSerializersT, 'Edm.Boolean', false, true>,
SEARCH_URL_ADDRESS: OrderableEdmTypeField<AddressHomePageUrl<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ADDRESS_COMMUNICATION_REMARK_TEXT: OrderableEdmTypeField<AddressHomePageUrl<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
URL_FIELD_LENGTH: OrderableEdmTypeField<AddressHomePageUrl<DeSerializers>, DeSerializersT, 'Edm.Int16', true, true>,
WEBSITE_URL: OrderableEdmTypeField<AddressHomePageUrl<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

...
export class CustAddrDepdntExtIdentifierApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
    EntityApi<
  ...
  requestBuilder(): CustAddrDepdntExtIdentifierRequestBuilder<
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<typeof CustAddrDepdntExtIdentifier, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(CustAddrDepdntExtIdentifier, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    CUSTOMER: OrderableEdmTypeField<CustAddrDepdntExtIdentifier<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
ADDRESS_ID: OrderableEdmTypeField<CustAddrDepdntExtIdentifier<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
CUSTOMER_EXTERNAL_REF_ID: OrderableEdmTypeField<CustAddrDepdntExtIdentifier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

...
export class BusinessPartnerTaxNumberApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof BusinessPartnerTaxNumber, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(BusinessPartnerTaxNumber, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    BUSINESS_PARTNER: OrderableEdmTypeField<BusinessPartnerTaxNumber<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
BP_TAX_TYPE: OrderableEdmTypeField<BusinessPartnerTaxNumber<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
BP_TAX_NUMBER: OrderableEdmTypeField<BusinessPartnerTaxNumber<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BP_TAX_LONG_NUMBER: OrderableEdmTypeField<BusinessPartnerTaxNumber<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
AUTHORIZATION_GROUP: OrderableEdmTypeField<BusinessPartnerTaxNumber<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

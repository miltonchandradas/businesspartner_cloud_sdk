...
export class CustomerDunningApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(CustomerDunning, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    CUSTOMER: OrderableEdmTypeField<CustomerDunning<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
COMPANY_CODE: OrderableEdmTypeField<CustomerDunning<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
DUNNING_AREA: OrderableEdmTypeField<CustomerDunning<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
DUNNING_BLOCK: OrderableEdmTypeField<CustomerDunning<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
DUNNING_LEVEL: OrderableEdmTypeField<CustomerDunning<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
DUNNING_PROCEDURE: OrderableEdmTypeField<CustomerDunning<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
DUNNING_RECIPIENT: OrderableEdmTypeField<CustomerDunning<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
LAST_DUNNED_ON: OrderableEdmTypeField<CustomerDunning<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
LEG_DUNNING_PROCEDURE_ON: OrderableEdmTypeField<CustomerDunning<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
DUNNING_CLERK: OrderableEdmTypeField<CustomerDunning<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
AUTHORIZATION_GROUP: OrderableEdmTypeField<CustomerDunning<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CUSTOMER_ACCOUNT_GROUP: OrderableEdmTypeField<CustomerDunning<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

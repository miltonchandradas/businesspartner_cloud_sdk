...
class CustAddrDepdntInformationRequestBuilder extends odata_v2_1.RequestBuilder {
    ...
    delete(customerOrEntity, addressId) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, customerOrEntity instanceof CustAddrDepdntInformation_1.CustAddrDepdntInformation ? customerOrEntity : {

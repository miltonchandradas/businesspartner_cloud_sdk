...
export class BusinessPartnerBankApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof BusinessPartnerBank, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(BusinessPartnerBank, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    BUSINESS_PARTNER: OrderableEdmTypeField<BusinessPartnerBank<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
BANK_IDENTIFICATION: OrderableEdmTypeField<BusinessPartnerBank<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
BANK_COUNTRY_KEY: OrderableEdmTypeField<BusinessPartnerBank<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BANK_NAME: OrderableEdmTypeField<BusinessPartnerBank<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BANK_NUMBER: OrderableEdmTypeField<BusinessPartnerBank<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SWIFT_CODE: OrderableEdmTypeField<BusinessPartnerBank<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BANK_CONTROL_KEY: OrderableEdmTypeField<BusinessPartnerBank<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BANK_ACCOUNT_HOLDER_NAME: OrderableEdmTypeField<BusinessPartnerBank<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BANK_ACCOUNT_NAME: OrderableEdmTypeField<BusinessPartnerBank<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
VALIDITY_START_DATE: OrderableEdmTypeField<BusinessPartnerBank<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
VALIDITY_END_DATE: OrderableEdmTypeField<BusinessPartnerBank<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
IBAN: OrderableEdmTypeField<BusinessPartnerBank<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
IBAN_VALIDITY_START_DATE: OrderableEdmTypeField<BusinessPartnerBank<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
BANK_ACCOUNT: OrderableEdmTypeField<BusinessPartnerBank<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BANK_ACCOUNT_REFERENCE_TEXT: OrderableEdmTypeField<BusinessPartnerBank<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
COLLECTION_AUTH_IND: OrderableEdmTypeField<BusinessPartnerBank<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
CITY_NAME: OrderableEdmTypeField<BusinessPartnerBank<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
AUTHORIZATION_GROUP: OrderableEdmTypeField<BusinessPartnerBank<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

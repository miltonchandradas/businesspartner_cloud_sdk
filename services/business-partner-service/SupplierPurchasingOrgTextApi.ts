...
export class SupplierPurchasingOrgTextApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof SupplierPurchasingOrgText, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(SupplierPurchasingOrgText, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    SUPPLIER: OrderableEdmTypeField<SupplierPurchasingOrgText<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
PURCHASING_ORGANIZATION: OrderableEdmTypeField<SupplierPurchasingOrgText<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
LANGUAGE: OrderableEdmTypeField<SupplierPurchasingOrgText<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
LONG_TEXT_ID: OrderableEdmTypeField<SupplierPurchasingOrgText<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
LONG_TEXT: OrderableEdmTypeField<SupplierPurchasingOrgText<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

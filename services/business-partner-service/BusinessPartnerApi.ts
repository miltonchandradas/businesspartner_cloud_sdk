...
import { CustomField, defaultDeSerializers, DefaultDeSerializers, DeSerializers, AllFields, entityBuilder, EntityBuilderType, EntityApi, FieldBuilder, Time, OrderableEdmTypeField, Link, OneToOneLink } from '@sap-cloud-sdk/odata-v2';
export class BusinessPartnerApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(BusinessPartner, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    BUSINESS_PARTNER: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
CUSTOMER: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SUPPLIER: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ACADEMIC_TITLE: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
AUTHORIZATION_GROUP: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BUSINESS_PARTNER_CATEGORY: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BUSINESS_PARTNER_FULL_NAME: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BUSINESS_PARTNER_GROUPING: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BUSINESS_PARTNER_NAME: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BUSINESS_PARTNER_UUID: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.Guid', true, true>,
CORRESPONDENCE_LANGUAGE: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CREATED_BY_USER: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CREATION_DATE: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
CREATION_TIME: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
FIRST_NAME: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
FORM_OF_ADDRESS: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INDUSTRY: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INTERNATIONAL_LOCATION_NUMBER_1: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INTERNATIONAL_LOCATION_NUMBER_2: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
IS_FEMALE: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
IS_MALE: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
IS_NATURAL_PERSON: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
IS_SEX_UNKNOWN: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
GENDER_CODE_NAME: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
LANGUAGE: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
LAST_CHANGE_DATE: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
LAST_CHANGE_TIME: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.Time', true, true>,
LAST_CHANGED_BY_USER: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
LAST_NAME: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
LEGAL_FORM: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ORGANIZATION_BP_NAME_1: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ORGANIZATION_BP_NAME_2: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ORGANIZATION_BP_NAME_3: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ORGANIZATION_BP_NAME_4: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ORGANIZATION_FOUNDATION_DATE: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
ORGANIZATION_LIQUIDATION_DATE: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
SEARCH_TERM_1: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SEARCH_TERM_2: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ADDITIONAL_LAST_NAME: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BIRTH_DATE: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
BUSINESS_PARTNER_BIRTH_DATE_STATUS: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BUSINESS_PARTNER_BIRTHPLACE_NAME: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BUSINESS_PARTNER_DEATH_DATE: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
BUSINESS_PARTNER_IS_BLOCKED: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
BUSINESS_PARTNER_TYPE: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
E_TAG: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
GROUP_BUSINESS_PARTNER_NAME_1: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
GROUP_BUSINESS_PARTNER_NAME_2: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INDEPENDENT_ADDRESS_ID: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INTERNATIONAL_LOCATION_NUMBER_3: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
MIDDLE_NAME: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
NAME_COUNTRY: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
NAME_FORMAT: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PERSON_FULL_NAME: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PERSON_NUMBER: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
IS_MARKED_FOR_ARCHIVING: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
BUSINESS_PARTNER_ID_BY_EXT_SYSTEM: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BUSINESS_PARTNER_PRINT_FORMAT: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BUSINESS_PARTNER_OCCUPATION: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BUS_PART_MARITAL_STATUS: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BUS_PART_NATIONALITY: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BUSINESS_PARTNER_BIRTH_NAME: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BUSINESS_PARTNER_SUPPLEMENT_NAME: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
NATURAL_PERSON_EMPLOYER_NAME: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
LAST_NAME_PREFIX: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
LAST_NAME_SECOND_PREFIX: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INITIALS: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TRADING_PARTNER: OrderableEdmTypeField<BusinessPartner<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
/**
 * Static representation of the one-to-many navigation property {@link toBuPaIdentification} for query construction.
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */

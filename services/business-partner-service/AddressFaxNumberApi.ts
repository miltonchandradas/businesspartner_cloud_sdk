...
export class AddressFaxNumberApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(AddressFaxNumber, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    ADDRESS_ID: OrderableEdmTypeField<AddressFaxNumber<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
PERSON: OrderableEdmTypeField<AddressFaxNumber<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
ORDINAL_NUMBER: OrderableEdmTypeField<AddressFaxNumber<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
IS_DEFAULT_FAX_NUMBER: OrderableEdmTypeField<AddressFaxNumber<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
FAX_COUNTRY: OrderableEdmTypeField<AddressFaxNumber<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
FAX_NUMBER: OrderableEdmTypeField<AddressFaxNumber<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
FAX_NUMBER_EXTENSION: OrderableEdmTypeField<AddressFaxNumber<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INTERNATIONAL_FAX_NUMBER: OrderableEdmTypeField<AddressFaxNumber<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ADDRESS_COMMUNICATION_REMARK_TEXT: OrderableEdmTypeField<AddressFaxNumber<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

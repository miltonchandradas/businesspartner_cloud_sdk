 ...
 */
export class BuPaIdentification<T extends DeSerializers = DefaultDeSerializers> extends Entity implements BuPaIdentificationType<T> {
  /**
   ...
   */
  static _keys = ['BusinessPartner', 'BPIdentificationType', 'BPIdentificationNumber'];
  /**

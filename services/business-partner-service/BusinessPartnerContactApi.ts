...
export class BusinessPartnerContactApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof BusinessPartnerContact, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(BusinessPartnerContact, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    RELATIONSHIP_NUMBER: OrderableEdmTypeField<BusinessPartnerContact<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
BUSINESS_PARTNER_COMPANY: OrderableEdmTypeField<BusinessPartnerContact<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
BUSINESS_PARTNER_PERSON: OrderableEdmTypeField<BusinessPartnerContact<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
VALIDITY_END_DATE: OrderableEdmTypeField<BusinessPartnerContact<DeSerializers>, DeSerializersT, 'Edm.DateTime', false, true>,
VALIDITY_START_DATE: OrderableEdmTypeField<BusinessPartnerContact<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
IS_STANDARD_RELATIONSHIP: OrderableEdmTypeField<BusinessPartnerContact<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
RELATIONSHIP_CATEGORY: OrderableEdmTypeField<BusinessPartnerContact<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
/**
 * Static representation of the one-to-many navigation property {@link toContactAddress} for query construction.
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */

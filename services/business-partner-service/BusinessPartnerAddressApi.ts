...
export class BusinessPartnerAddressApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
    EntityApi<
  ...
  _addNavigationProperties(
      linkedApis: [
        BuPaAddressUsageApi<DeSerializersT>,BpAddrDepdntIntlLocNumberApi<DeSerializersT>,AddressEmailAddressApi<DeSerializersT>,AddressFaxNumberApi<DeSerializersT>,AddressPhoneNumberApi<DeSerializersT>,AddressPhoneNumberApi<DeSerializersT>,AddressHomePageUrlApi<DeSerializersT>
      ]): this {
        this.navigationPropertyFields = {
          TO_ADDRESS_USAGE: new Link(
              'to_AddressUsage',
              this,
              linkedApis[0]
            ),
  ...
  requestBuilder(): BusinessPartnerAddressRequestBuilder<
    DeSerializersT
  > {
  ...
  private _fieldBuilder?: FieldBuilder<typeof BusinessPartnerAddress, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(BusinessPartnerAddress, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    BUSINESS_PARTNER: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
ADDRESS_ID: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
VALIDITY_START_DATE: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
VALIDITY_END_DATE: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
AUTHORIZATION_GROUP: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ADDRESS_UUID: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.Guid', true, true>,
ADDITIONAL_STREET_PREFIX_NAME: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ADDITIONAL_STREET_SUFFIX_NAME: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ADDRESS_TIME_ZONE: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CARE_OF_NAME: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CITY_CODE: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CITY_NAME: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
COMPANY_POSTAL_CODE: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
COUNTRY: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
COUNTY: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
DELIVERY_SERVICE_NUMBER: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
DELIVERY_SERVICE_TYPE_CODE: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
DISTRICT: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
FORM_OF_ADDRESS: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
FULL_NAME: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
HOME_CITY_NAME: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
HOUSE_NUMBER: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
HOUSE_NUMBER_SUPPLEMENT_TEXT: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
LANGUAGE: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PO_BOX: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PO_BOX_DEVIATING_CITY_NAME: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PO_BOX_DEVIATING_COUNTRY: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PO_BOX_DEVIATING_REGION: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PO_BOX_IS_WITHOUT_NUMBER: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
PO_BOX_LOBBY_NAME: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PO_BOX_POSTAL_CODE: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PERSON: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
POSTAL_CODE: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PRFRD_COMM_MEDIUM_TYPE: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
REGION: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
STREET_NAME: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
STREET_PREFIX_NAME: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
STREET_SUFFIX_NAME: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TAX_JURISDICTION: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TRANSPORT_ZONE: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ADDRESS_ID_BY_EXTERNAL_SYSTEM: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
COUNTY_CODE: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TOWNSHIP_CODE: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TOWNSHIP_NAME: OrderableEdmTypeField<BusinessPartnerAddress<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
/**
 * Static representation of the one-to-many navigation property {@link toAddressUsage} for query construction.
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */

...
export class CustomerCompanyApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(CustomerCompany, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    CUSTOMER: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
COMPANY_CODE: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
APAR_TOLERANCE_GROUP: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ACCOUNT_BY_CUSTOMER: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ACCOUNTING_CLERK: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ACCOUNTING_CLERK_FAX_NUMBER: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ACCOUNTING_CLERK_INTERNET_ADDRESS: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ACCOUNTING_CLERK_PHONE_NUMBER: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ALTERNATIVE_PAYER_ACCOUNT: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
AUTHORIZATION_GROUP: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
COLLECTIVE_INVOICE_VARIANT: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CUSTOMER_ACCOUNT_NOTE: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CUSTOMER_HEAD_OFFICE: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CUSTOMER_SUPPLIER_CLEARING_IS_USED: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
HOUSE_BANK: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INTEREST_CALCULATION_CODE: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INTEREST_CALCULATION_DATE: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
INTRST_CALC_FREQUENCY_IN_MONTHS: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
IS_TO_BE_LOCALLY_PROCESSED: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
ITEM_IS_TO_BE_PAID_SEPARATELY: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
LAYOUT_SORTING_RULE: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PAYMENT_BLOCKING_REASON: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PAYMENT_METHODS_LIST: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PAYMENT_TERMS: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PAYT_ADVICE_IS_SENTBY_EDI: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
PHYSICAL_INVENTORY_BLOCK_IND: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
RECONCILIATION_ACCOUNT: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
RECORD_PAYMENT_HISTORY_INDICATOR: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
USER_AT_CUSTOMER: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
DELETION_INDICATOR: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
CASH_PLANNING_GROUP: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
KNOWN_OR_NEGOTIATED_LEAVE: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
VALUE_ADJUSTMENT_KEY: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CUSTOMER_ACCOUNT_GROUP: OrderableEdmTypeField<CustomerCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
/**
 * Static representation of the one-to-many navigation property {@link toCompanyText} for query construction.
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */

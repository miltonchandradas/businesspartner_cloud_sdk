...
class CustUnldgPtAddrDepdntInfoRequestBuilder extends odata_v2_1.RequestBuilder {
    ...
    delete(customerOrEntity, addressId, unloadingPointName) {
        return new odata_v2_1.DeleteRequestBuilder(this.entityApi, customerOrEntity instanceof CustUnldgPtAddrDepdntInfo_1.CustUnldgPtAddrDepdntInfo ? customerOrEntity : {

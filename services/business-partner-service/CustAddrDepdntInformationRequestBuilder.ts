 ...
 */
export class CustAddrDepdntInformationRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<CustAddrDepdntInformation<T>, T> {
  /**
  ...
  getByKey(customer: DeserializedType<T, 'Edm.String'>, addressId: DeserializedType<T, 'Edm.String'>): GetByKeyRequestBuilder<CustAddrDepdntInformation<T>, T> {
    return new GetByKeyRequestBuilder<CustAddrDepdntInformation<T>, T>(this.entityApi, {
      Customer: customer,
      AddressID: addressId
    });
  }
  ...
  getAll(): GetAllRequestBuilder<CustAddrDepdntInformation<T>, T> {
    return new GetAllRequestBuilder<CustAddrDepdntInformation<T>, T>(this.entityApi);
  }
  ...
  create(entity: CustAddrDepdntInformation<T>): CreateRequestBuilder<CustAddrDepdntInformation<T>, T> {
    return new CreateRequestBuilder<CustAddrDepdntInformation<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: CustAddrDepdntInformation<T>): UpdateRequestBuilder<CustAddrDepdntInformation<T>, T> {
    return new UpdateRequestBuilder<CustAddrDepdntInformation<T>, T>(this.entityApi, entity);
  }
  ...
  delete(customerOrEntity: any, addressId?: string): DeleteRequestBuilder<CustAddrDepdntInformation<T>, T> {
    return new DeleteRequestBuilder<CustAddrDepdntInformation<T>, T>(this.entityApi, customerOrEntity instanceof CustAddrDepdntInformation ? customerOrEntity : {

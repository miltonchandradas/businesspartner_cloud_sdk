...
export class AddressPhoneNumberApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof AddressPhoneNumber, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(AddressPhoneNumber, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    ADDRESS_ID: OrderableEdmTypeField<AddressPhoneNumber<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
PERSON: OrderableEdmTypeField<AddressPhoneNumber<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
ORDINAL_NUMBER: OrderableEdmTypeField<AddressPhoneNumber<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
DESTINATION_LOCATION_COUNTRY: OrderableEdmTypeField<AddressPhoneNumber<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
IS_DEFAULT_PHONE_NUMBER: OrderableEdmTypeField<AddressPhoneNumber<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
PHONE_NUMBER: OrderableEdmTypeField<AddressPhoneNumber<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PHONE_NUMBER_EXTENSION: OrderableEdmTypeField<AddressPhoneNumber<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INTERNATIONAL_PHONE_NUMBER: OrderableEdmTypeField<AddressPhoneNumber<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PHONE_NUMBER_TYPE: OrderableEdmTypeField<AddressPhoneNumber<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ADDRESS_COMMUNICATION_REMARK_TEXT: OrderableEdmTypeField<AddressPhoneNumber<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

 ...
 */
export class AddressHomePageUrlRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<AddressHomePageUrl<T>, T> {
  /**
  ...
  getByKey(addressId: DeserializedType<T, 'Edm.String'>, person: DeserializedType<T, 'Edm.String'>, ordinalNumber: DeserializedType<T, 'Edm.String'>, validityStartDate: DeserializedType<T, 'Edm.DateTime'>, isDefaultUrlAddress: DeserializedType<T, 'Edm.Boolean'>): GetByKeyRequestBuilder<AddressHomePageUrl<T>, T> {
    return new GetByKeyRequestBuilder<AddressHomePageUrl<T>, T>(this.entityApi, {
      AddressID: addressId,
      Person: person,
  ...
  create(entity: AddressHomePageUrl<T>): CreateRequestBuilder<AddressHomePageUrl<T>, T> {
    return new CreateRequestBuilder<AddressHomePageUrl<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: AddressHomePageUrl<T>): UpdateRequestBuilder<AddressHomePageUrl<T>, T> {
    return new UpdateRequestBuilder<AddressHomePageUrl<T>, T>(this.entityApi, entity);
  }
  ...
  delete(addressIdOrEntity: any, person?: string, ordinalNumber?: string, validityStartDate?: Moment, isDefaultUrlAddress?: boolean): DeleteRequestBuilder<AddressHomePageUrl<T>, T> {
    return new DeleteRequestBuilder<AddressHomePageUrl<T>, T>(this.entityApi, addressIdOrEntity instanceof AddressHomePageUrl ? addressIdOrEntity : {

...
export class SupplierWithHoldingTaxApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof SupplierWithHoldingTax, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(SupplierWithHoldingTax, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    SUPPLIER: OrderableEdmTypeField<SupplierWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
COMPANY_CODE: OrderableEdmTypeField<SupplierWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
WITHHOLDING_TAX_TYPE: OrderableEdmTypeField<SupplierWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
EXEMPTION_DATE_BEGIN: OrderableEdmTypeField<SupplierWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
EXEMPTION_DATE_END: OrderableEdmTypeField<SupplierWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
EXEMPTION_REASON: OrderableEdmTypeField<SupplierWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
IS_WITHHOLDING_TAX_SUBJECT: OrderableEdmTypeField<SupplierWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
RECIPIENT_TYPE: OrderableEdmTypeField<SupplierWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
WITHHOLDING_TAX_CERTIFICATE: OrderableEdmTypeField<SupplierWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
WITHHOLDING_TAX_CODE: OrderableEdmTypeField<SupplierWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
WITHHOLDING_TAX_EXMPT_PERCENT: OrderableEdmTypeField<SupplierWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.Decimal', true, true>,
WITHHOLDING_TAX_NUMBER: OrderableEdmTypeField<SupplierWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
AUTHORIZATION_GROUP: OrderableEdmTypeField<SupplierWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

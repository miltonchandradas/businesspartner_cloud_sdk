 ...
 */
export class CustAddrDepdntExtIdentifierRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<CustAddrDepdntExtIdentifier<T>, T> {
  /**
  ...
  getByKey(customer: DeserializedType<T, 'Edm.String'>, addressId: DeserializedType<T, 'Edm.String'>): GetByKeyRequestBuilder<CustAddrDepdntExtIdentifier<T>, T> {
    return new GetByKeyRequestBuilder<CustAddrDepdntExtIdentifier<T>, T>(this.entityApi, {
      Customer: customer,
      AddressID: addressId
    });
  }
  ...
  getAll(): GetAllRequestBuilder<CustAddrDepdntExtIdentifier<T>, T> {
    return new GetAllRequestBuilder<CustAddrDepdntExtIdentifier<T>, T>(this.entityApi);
  }
  ...
  create(entity: CustAddrDepdntExtIdentifier<T>): CreateRequestBuilder<CustAddrDepdntExtIdentifier<T>, T> {
    return new CreateRequestBuilder<CustAddrDepdntExtIdentifier<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: CustAddrDepdntExtIdentifier<T>): UpdateRequestBuilder<CustAddrDepdntExtIdentifier<T>, T> {
    return new UpdateRequestBuilder<CustAddrDepdntExtIdentifier<T>, T>(this.entityApi, entity);
  }
  ...
  delete(customerOrEntity: any, addressId?: string): DeleteRequestBuilder<CustAddrDepdntExtIdentifier<T>, T> {
    return new DeleteRequestBuilder<CustAddrDepdntExtIdentifier<T>, T>(this.entityApi, customerOrEntity instanceof CustAddrDepdntExtIdentifier ? customerOrEntity : {

...
export class CustomerWithHoldingTaxApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof CustomerWithHoldingTax, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(CustomerWithHoldingTax, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    CUSTOMER: OrderableEdmTypeField<CustomerWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
COMPANY_CODE: OrderableEdmTypeField<CustomerWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
WITHHOLDING_TAX_TYPE: OrderableEdmTypeField<CustomerWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
WITHHOLDING_TAX_CODE: OrderableEdmTypeField<CustomerWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
WITHHOLDING_TAX_AGENT: OrderableEdmTypeField<CustomerWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
OBLIGATION_DATE_BEGIN: OrderableEdmTypeField<CustomerWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
OBLIGATION_DATE_END: OrderableEdmTypeField<CustomerWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
WITHHOLDING_TAX_NUMBER: OrderableEdmTypeField<CustomerWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
WITHHOLDING_TAX_CERTIFICATE: OrderableEdmTypeField<CustomerWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
WITHHOLDING_TAX_EXMPT_PERCENT: OrderableEdmTypeField<CustomerWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.Decimal', true, true>,
EXEMPTION_DATE_BEGIN: OrderableEdmTypeField<CustomerWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
EXEMPTION_DATE_END: OrderableEdmTypeField<CustomerWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
EXEMPTION_REASON: OrderableEdmTypeField<CustomerWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
AUTHORIZATION_GROUP: OrderableEdmTypeField<CustomerWithHoldingTax<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

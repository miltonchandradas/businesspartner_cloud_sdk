...
export class CustomerCompanyTextApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof CustomerCompanyText, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(CustomerCompanyText, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    CUSTOMER: OrderableEdmTypeField<CustomerCompanyText<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
COMPANY_CODE: OrderableEdmTypeField<CustomerCompanyText<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
LANGUAGE: OrderableEdmTypeField<CustomerCompanyText<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
LONG_TEXT_ID: OrderableEdmTypeField<CustomerCompanyText<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
LONG_TEXT: OrderableEdmTypeField<CustomerCompanyText<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ALL_FIELDS: AllFields<CustomerCompanyText<DeSerializers>>
  };

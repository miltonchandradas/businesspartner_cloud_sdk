...
export class BuPaIndustryApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _schema?: {
    INDUSTRY_SECTOR: OrderableEdmTypeField<BuPaIndustry<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
INDUSTRY_SYSTEM_TYPE: OrderableEdmTypeField<BuPaIndustry<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
BUSINESS_PARTNER: OrderableEdmTypeField<BuPaIndustry<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
IS_STANDARD_INDUSTRY: OrderableEdmTypeField<BuPaIndustry<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INDUSTRY_KEY_DESCRIPTION: OrderableEdmTypeField<BuPaIndustry<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

...
export class CustomerSalesAreaTextApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof CustomerSalesAreaText, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(CustomerSalesAreaText, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    CUSTOMER: OrderableEdmTypeField<CustomerSalesAreaText<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
SALES_ORGANIZATION: OrderableEdmTypeField<CustomerSalesAreaText<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
DISTRIBUTION_CHANNEL: OrderableEdmTypeField<CustomerSalesAreaText<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
DIVISION: OrderableEdmTypeField<CustomerSalesAreaText<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
LANGUAGE: OrderableEdmTypeField<CustomerSalesAreaText<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
LONG_TEXT_ID: OrderableEdmTypeField<CustomerSalesAreaText<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
LONG_TEXT: OrderableEdmTypeField<CustomerSalesAreaText<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

...
export class BuPaIdentificationApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof BuPaIdentification, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(BuPaIdentification, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    BUSINESS_PARTNER: OrderableEdmTypeField<BuPaIdentification<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
BP_IDENTIFICATION_TYPE: OrderableEdmTypeField<BuPaIdentification<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
BP_IDENTIFICATION_NUMBER: OrderableEdmTypeField<BuPaIdentification<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
BP_IDN_NMBR_ISSUING_INSTITUTE: OrderableEdmTypeField<BuPaIdentification<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BP_IDENTIFICATION_ENTRY_DATE: OrderableEdmTypeField<BuPaIdentification<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
COUNTRY: OrderableEdmTypeField<BuPaIdentification<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
REGION: OrderableEdmTypeField<BuPaIdentification<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
VALIDITY_START_DATE: OrderableEdmTypeField<BuPaIdentification<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
VALIDITY_END_DATE: OrderableEdmTypeField<BuPaIdentification<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
AUTHORIZATION_GROUP: OrderableEdmTypeField<BuPaIdentification<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

...
export class SupplierPurchasingOrgApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof SupplierPurchasingOrg, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(SupplierPurchasingOrg, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    SUPPLIER: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
PURCHASING_ORGANIZATION: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
CALCULATION_SCHEMA_GROUP_CODE: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
DELETION_INDICATOR: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
INCOTERMS_CLASSIFICATION: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INCOTERMS_TRANSFER_LOCATION: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INCOTERMS_VERSION: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INCOTERMS_LOCATION_1: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INCOTERMS_LOCATION_2: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INVOICE_IS_GOODS_RECEIPT_BASED: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
MATERIAL_PLANNED_DELIVERY_DURN: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.Decimal', true, true>,
MINIMUM_ORDER_AMOUNT: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.Decimal', true, true>,
PAYMENT_TERMS: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PRICING_DATE_CONTROL: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PUR_ORD_AUTO_GENERATION_IS_ALLOWED: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
PURCHASE_ORDER_CURRENCY: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PURCHASING_GROUP: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PURCHASING_IS_BLOCKED_FOR_SUPPLIER: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
SHIPPING_CONDITION: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SUPPLIER_ABC_CLASSIFICATION_CODE: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SUPPLIER_PHONE_NUMBER: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SUPPLIER_RESP_SALES_PERSON_NAME: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SUPPLIER_CONFIRMATION_CONTROL_KEY: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
IS_ORDER_ACKN_RQD: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
AUTHORIZATION_GROUP: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SUPPLIER_ACCOUNT_GROUP: OrderableEdmTypeField<SupplierPurchasingOrg<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
/**
 * Static representation of the one-to-many navigation property {@link toPartnerFunction} for query construction.
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */

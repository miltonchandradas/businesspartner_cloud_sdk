...
export class SupplierPartnerFuncApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof SupplierPartnerFunc, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(SupplierPartnerFunc, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    SUPPLIER: OrderableEdmTypeField<SupplierPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
PURCHASING_ORGANIZATION: OrderableEdmTypeField<SupplierPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
SUPPLIER_SUBRANGE: OrderableEdmTypeField<SupplierPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
PLANT: OrderableEdmTypeField<SupplierPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
PARTNER_FUNCTION: OrderableEdmTypeField<SupplierPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
PARTNER_COUNTER: OrderableEdmTypeField<SupplierPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
DEFAULT_PARTNER: OrderableEdmTypeField<SupplierPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
CREATION_DATE: OrderableEdmTypeField<SupplierPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
CREATED_BY_USER: OrderableEdmTypeField<SupplierPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
REFERENCE_SUPPLIER: OrderableEdmTypeField<SupplierPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
AUTHORIZATION_GROUP: OrderableEdmTypeField<SupplierPartnerFunc<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

...
export class BusinessPartnerRoleApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof BusinessPartnerRole, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(BusinessPartnerRole, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    BUSINESS_PARTNER: OrderableEdmTypeField<BusinessPartnerRole<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
BUSINESS_PARTNER_ROLE: OrderableEdmTypeField<BusinessPartnerRole<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
VALID_FROM: OrderableEdmTypeField<BusinessPartnerRole<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
VALID_TO: OrderableEdmTypeField<BusinessPartnerRole<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
AUTHORIZATION_GROUP: OrderableEdmTypeField<BusinessPartnerRole<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

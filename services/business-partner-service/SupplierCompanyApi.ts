...
export class SupplierCompanyApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
    EntityApi<
      SupplierCompany<
        DeSerializersT
      >, 
  ...
  _addNavigationProperties(
      linkedApis: [
        SupplierCompanyTextApi<DeSerializersT>,SupplierApi<DeSerializersT>,SupplierDunningApi<DeSerializersT>,SupplierWithHoldingTaxApi<DeSerializersT>
      ]): this {
  ...
  requestBuilder(): SupplierCompanyRequestBuilder<
    DeSerializersT
  > {
  ...
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(SupplierCompany, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    SUPPLIER: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
COMPANY_CODE: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
AUTHORIZATION_GROUP: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
COMPANY_CODE_NAME: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PAYMENT_BLOCKING_REASON: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SUPPLIER_IS_BLOCKED_FOR_POSTING: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
ACCOUNTING_CLERK: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ACCOUNTING_CLERK_FAX_NUMBER: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ACCOUNTING_CLERK_PHONE_NUMBER: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SUPPLIER_CLERK: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SUPPLIER_CLERK_URL: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PAYMENT_METHODS_LIST: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PAYMENT_TERMS: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CLEAR_CUSTOMER_SUPPLIER: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
IS_TO_BE_LOCALLY_PROCESSED: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
ITEM_IS_TO_BE_PAID_SEPARATELY: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
PAYMENT_IS_TO_BE_SENT_BY_EDI: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
HOUSE_BANK: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CHECK_PAID_DURATION_IN_DAYS: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.Decimal', true, true>,
CURRENCY: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BILL_OF_EXCH_LMT_AMT_IN_CO_CODE_CRCY: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.Decimal', true, true>,
SUPPLIER_CLERK_ID_BY_SUPPLIER: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
RECONCILIATION_ACCOUNT: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INTEREST_CALCULATION_CODE: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INTEREST_CALCULATION_DATE: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
INTRST_CALC_FREQUENCY_IN_MONTHS: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SUPPLIER_HEAD_OFFICE: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ALTERNATIVE_PAYEE: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
LAYOUT_SORTING_RULE: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
APAR_TOLERANCE_GROUP: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SUPPLIER_CERTIFICATION_DATE: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
SUPPLIER_ACCOUNT_NOTE: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
WITHHOLDING_TAX_COUNTRY: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
DELETION_INDICATOR: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
CASH_PLANNING_GROUP: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
IS_TO_BE_CHECKED_FOR_DUPLICATES: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
MINORITY_GROUP: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SUPPLIER_ACCOUNT_GROUP: OrderableEdmTypeField<SupplierCompany<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
/**
 * Static representation of the one-to-many navigation property {@link toCompanyText} for query construction.
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */

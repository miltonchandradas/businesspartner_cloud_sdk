...
class BusinessPartnerService<DeSerializersT extends DeSerializers = DefaultDeSerializers> {
    ...
    get bpAddrDepdntIntlLocNumberApi(): BpAddrDepdntIntlLocNumberApi<DeSerializersT> { 
        return this.initApi('bpAddrDepdntIntlLocNumberApi', BpAddrDepdntIntlLocNumberApi)    
      }
    ...
    get businessPartnerAddressApi(): BusinessPartnerAddressApi<DeSerializersT> { 
        ...
        this.initApi('bpAddrDepdntIntlLocNumberApi', BpAddrDepdntIntlLocNumberApi),
        this.initApi('addressEmailAddressApi', AddressEmailAddressApi),
        this.initApi('addressFaxNumberApi', AddressFaxNumberApi),
        this.initApi('addressPhoneNumberApi', AddressPhoneNumberApi),
        this.initApi('addressPhoneNumberApi', AddressPhoneNumberApi),
    ...
    get busPartAddrDepdntTaxNmbrApi(): BusPartAddrDepdntTaxNmbrApi<DeSerializersT> { 
        return this.initApi('busPartAddrDepdntTaxNmbrApi', BusPartAddrDepdntTaxNmbrApi)    
      }
    
    get custAddrDepdntExtIdentifierApi(): CustAddrDepdntExtIdentifierApi<DeSerializersT> { 
        return this.initApi('custAddrDepdntExtIdentifierApi', CustAddrDepdntExtIdentifierApi)    
      }
    
    get custAddrDepdntInformationApi(): CustAddrDepdntInformationApi<DeSerializersT> { 
        return this.initApi('custAddrDepdntInformationApi', CustAddrDepdntInformationApi)    
      }
    
    get customerApi(): CustomerApi<DeSerializersT> { 
        const api = this.initApi('customerApi', CustomerApi);
          const linkedApis = [
            this.initApi('custAddrDepdntExtIdentifierApi', CustAddrDepdntExtIdentifierApi),
        this.initApi('custAddrDepdntInformationApi', CustAddrDepdntInformationApi),
    ...
    get customerSalesAreaTaxApi(): CustomerSalesAreaTaxApi<DeSerializersT> { 
        const api = this.initApi('customerSalesAreaTaxApi', CustomerSalesAreaTaxApi);
          const linkedApis = [
            this.initApi('custSlsAreaAddrDepdntTaxInfoApi', CustSlsAreaAddrDepdntTaxInfoApi)
          ];
          api._addNavigationProperties(linkedApis);
          return api    
      }
    ...
    get custSlsAreaAddrDepdntInfoApi(): CustSlsAreaAddrDepdntInfoApi<DeSerializersT> { 
        return this.initApi('custSlsAreaAddrDepdntInfoApi', CustSlsAreaAddrDepdntInfoApi)    
      }
    
    get custSlsAreaAddrDepdntTaxInfoApi(): CustSlsAreaAddrDepdntTaxInfoApi<DeSerializersT> { 
        return this.initApi('custSlsAreaAddrDepdntTaxInfoApi', CustSlsAreaAddrDepdntTaxInfoApi)    
      }
    
    get custUnldgPtAddrDepdntInfoApi(): CustUnldgPtAddrDepdntInfoApi<DeSerializersT> { 
        return this.initApi('custUnldgPtAddrDepdntInfoApi', CustUnldgPtAddrDepdntInfoApi)    
      }

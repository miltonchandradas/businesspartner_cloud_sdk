...
export class BuPaAddressUsageApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(BuPaAddressUsage, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    BUSINESS_PARTNER: OrderableEdmTypeField<BuPaAddressUsage<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
VALIDITY_END_DATE: OrderableEdmTypeField<BuPaAddressUsage<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', false, true>,
ADDRESS_USAGE: OrderableEdmTypeField<BuPaAddressUsage<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
ADDRESS_ID: OrderableEdmTypeField<BuPaAddressUsage<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
VALIDITY_START_DATE: OrderableEdmTypeField<BuPaAddressUsage<DeSerializers>, DeSerializersT, 'Edm.DateTimeOffset', true, true>,
STANDARD_USAGE: OrderableEdmTypeField<BuPaAddressUsage<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
AUTHORIZATION_GROUP: OrderableEdmTypeField<BuPaAddressUsage<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,

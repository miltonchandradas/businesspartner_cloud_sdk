 ...
 */
export class CustUnldgPtAddrDepdntInfo<T extends DeSerializers = DefaultDeSerializers> extends Entity implements CustUnldgPtAddrDepdntInfoType<T> {
  /**
   ...
   */
  static _keys = ['Customer', 'AddressID', 'UnloadingPointName'];
  /**
   * Customer Number.
   * Maximum length: 10.
   */

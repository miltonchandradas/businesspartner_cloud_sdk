...
export class CustomerTaxGroupingApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _fieldBuilder?: FieldBuilder<typeof CustomerTaxGrouping, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(CustomerTaxGrouping, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    CUSTOMER: OrderableEdmTypeField<CustomerTaxGrouping<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
CUSTOMER_TAX_GROUPING_CODE: OrderableEdmTypeField<CustomerTaxGrouping<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
CUST_TAX_GRP_EXEMPTION_CERTIFICATE: OrderableEdmTypeField<CustomerTaxGrouping<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CUST_TAX_GROUP_EXEMPTION_RATE: OrderableEdmTypeField<CustomerTaxGrouping<DeSerializers>, DeSerializersT, 'Edm.Decimal', true, true>,
CUST_TAX_GROUP_EXEMPTION_START_DATE: OrderableEdmTypeField<CustomerTaxGrouping<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
CUST_TAX_GROUP_EXEMPTION_END_DATE: OrderableEdmTypeField<CustomerTaxGrouping<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
CUST_TAX_GROUP_SUBJECTED_START_DATE: OrderableEdmTypeField<CustomerTaxGrouping<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
CUST_TAX_GROUP_SUBJECTED_END_DATE: OrderableEdmTypeField<CustomerTaxGrouping<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,

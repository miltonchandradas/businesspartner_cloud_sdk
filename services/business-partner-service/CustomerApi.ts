...
export class CustomerApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
    EntityApi<
      Customer<
        DeSerializersT
      >, 
  ...
  _addNavigationProperties(
      linkedApis: [
        CustAddrDepdntExtIdentifierApi<DeSerializersT>,CustAddrDepdntInformationApi<DeSerializersT>,CustomerCompanyApi<DeSerializersT>,CustomerSalesAreaApi<DeSerializersT>,CustomerTaxGroupingApi<DeSerializersT>,CustomerTextApi<DeSerializersT>,CustomerUnloadingPointApi<DeSerializersT>,CustUnldgPtAddrDepdntInfoApi<DeSerializersT>
      ]): this {
        this.navigationPropertyFields = {
          TO_CUST_ADDR_DEPDNT_EXT_IDENTIFIER: new Link(
              'to_CustAddrDepdntExtIdentifier',
              this,
              linkedApis[0]
            ),
          TO_CUST_ADDR_DEPDNT_INFORMATION: new Link(
              'to_CustAddrDepdntInformation',
              this,
              linkedApis[1]
            ),
          TO_CUSTOMER_COMPANY: new Link(
              'to_CustomerCompany',
              this,
              linkedApis[2]
            ),
          ...
          TO_CUST_UNLDG_PT_ADDR_DEPDNT_INFO: new Link(
  ...
  requestBuilder(): CustomerRequestBuilder<
    DeSerializersT
  > {
  ...
  private _schema?: {
    CUSTOMER: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
AUTHORIZATION_GROUP: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BILLING_IS_BLOCKED_FOR_CUSTOMER: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CREATED_BY_USER: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CREATION_DATE: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
CUSTOMER_ACCOUNT_GROUP: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CUSTOMER_CLASSIFICATION: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CUSTOMER_FULL_NAME: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CUSTOMER_NAME: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
DELIVERY_IS_BLOCKED: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
NF_PARTNER_IS_NATURAL_PERSON: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
ORDER_IS_BLOCKED_FOR_CUSTOMER: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
POSTING_IS_BLOCKED: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
SUPPLIER: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CUSTOMER_CORPORATE_GROUP: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
FISCAL_ADDRESS: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INDUSTRY: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INDUSTRY_CODE_1: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INDUSTRY_CODE_2: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INDUSTRY_CODE_3: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INDUSTRY_CODE_4: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INDUSTRY_CODE_5: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INTERNATIONAL_LOCATION_NUMBER_1: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
NIELSEN_REGION: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
RESPONSIBLE_TYPE: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TAX_NUMBER_1: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TAX_NUMBER_2: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TAX_NUMBER_3: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TAX_NUMBER_4: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TAX_NUMBER_5: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TAX_NUMBER_TYPE: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
VAT_REGISTRATION: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
DELETION_INDICATOR: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
EXPRESS_TRAIN_STATION_NAME: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TRAIN_STATION_NAME: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CITY_CODE: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
COUNTY: OrderableEdmTypeField<Customer<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
/**
 * Static representation of the one-to-many navigation property {@link toCustAddrDepdntExtIdentifier} for query construction.
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */

...
export class SupplierApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  private _schema?: {
    SUPPLIER: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
ALTERNATIVE_PAYEE_ACCOUNT_NUMBER: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
AUTHORIZATION_GROUP: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CREATED_BY_USER: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
CREATION_DATE: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
CUSTOMER: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
PAYMENT_IS_BLOCKED_FOR_SUPPLIER: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
POSTING_IS_BLOCKED: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
PURCHASING_IS_BLOCKED: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
SUPPLIER_ACCOUNT_GROUP: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SUPPLIER_FULL_NAME: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SUPPLIER_NAME: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
VAT_REGISTRATION: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BIRTH_DATE: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
CONCATENATED_INTERNATIONAL_LOC_NO: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
DELETION_INDICATOR: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
FISCAL_ADDRESS: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INDUSTRY: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INTERNATIONAL_LOCATION_NUMBER_1: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INTERNATIONAL_LOCATION_NUMBER_2: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
INTERNATIONAL_LOCATION_NUMBER_3: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
IS_NATURAL_PERSON: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
RESPONSIBLE_TYPE: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SUPLR_QLTY_IN_PROCMT_CERTFN_VALID_TO: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.DateTime', true, true>,
SUPLR_QUALITY_MANAGEMENT_SYSTEM: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SUPPLIER_CORPORATE_GROUP: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SUPPLIER_PROCUREMENT_BLOCK: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TAX_NUMBER_1: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TAX_NUMBER_2: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TAX_NUMBER_3: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TAX_NUMBER_4: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TAX_NUMBER_5: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TAX_NUMBER_RESPONSIBLE: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
TAX_NUMBER_TYPE: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
SUPLR_PROOF_OF_DELIV_RLVT_CODE: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
BR_TAX_IS_SPLIT: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.Boolean', true, true>,
DATA_EXCHANGE_INSTRUCTION_KEY: OrderableEdmTypeField<Supplier<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
/**
 * Static representation of the one-to-many navigation property {@link toSupplierCompany} for query construction.
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */

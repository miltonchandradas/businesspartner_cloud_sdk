 ...
 */
export class CustomerUnloadingPointRequestBuilder<T extends DeSerializers = DefaultDeSerializers> extends RequestBuilder<CustomerUnloadingPoint<T>, T> {
  /**
  ...
  getByKey(customer: DeserializedType<T, 'Edm.String'>, unloadingPointName: DeserializedType<T, 'Edm.String'>): GetByKeyRequestBuilder<CustomerUnloadingPoint<T>, T> {
    return new GetByKeyRequestBuilder<CustomerUnloadingPoint<T>, T>(this.entityApi, {
      Customer: customer,
  ...
  getAll(): GetAllRequestBuilder<CustomerUnloadingPoint<T>, T> {
    return new GetAllRequestBuilder<CustomerUnloadingPoint<T>, T>(this.entityApi);
  }
  ...
  create(entity: CustomerUnloadingPoint<T>): CreateRequestBuilder<CustomerUnloadingPoint<T>, T> {
    return new CreateRequestBuilder<CustomerUnloadingPoint<T>, T>(this.entityApi, entity);
  }
  ...
  update(entity: CustomerUnloadingPoint<T>): UpdateRequestBuilder<CustomerUnloadingPoint<T>, T> {
    return new UpdateRequestBuilder<CustomerUnloadingPoint<T>, T>(this.entityApi, entity);
  }
  ...
  delete(customerOrEntity: any, unloadingPointName?: string): DeleteRequestBuilder<CustomerUnloadingPoint<T>, T> {
    return new DeleteRequestBuilder<CustomerUnloadingPoint<T>, T>(this.entityApi, customerOrEntity instanceof CustomerUnloadingPoint ? customerOrEntity : {

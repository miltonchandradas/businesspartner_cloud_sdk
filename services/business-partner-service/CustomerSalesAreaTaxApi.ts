...
export class CustomerSalesAreaTaxApi<DeSerializersT extends DeSerializers = DefaultDeSerializers> implements 
  ...
  _addNavigationProperties(
      linkedApis: [
        ...
        this.navigationPropertyFields = {
          TO_SLS_AREA_ADDR_DEPDNT_TAX: new Link(
  ...
  private _fieldBuilder?: FieldBuilder<typeof CustomerSalesAreaTax, DeSerializersT>;
  get fieldBuilder() {
    if(!this._fieldBuilder){
      this._fieldBuilder = new FieldBuilder(CustomerSalesAreaTax, this.deSerializers);
    }
    return this._fieldBuilder;
  }

  private _schema?: {
    CUSTOMER: OrderableEdmTypeField<CustomerSalesAreaTax<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
SALES_ORGANIZATION: OrderableEdmTypeField<CustomerSalesAreaTax<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
DISTRIBUTION_CHANNEL: OrderableEdmTypeField<CustomerSalesAreaTax<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
DIVISION: OrderableEdmTypeField<CustomerSalesAreaTax<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
DEPARTURE_COUNTRY: OrderableEdmTypeField<CustomerSalesAreaTax<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
CUSTOMER_TAX_CATEGORY: OrderableEdmTypeField<CustomerSalesAreaTax<DeSerializers>, DeSerializersT, 'Edm.String', false, true>,
CUSTOMER_TAX_CLASSIFICATION: OrderableEdmTypeField<CustomerSalesAreaTax<DeSerializers>, DeSerializersT, 'Edm.String', true, true>,
/**
 * Static representation of the one-to-many navigation property {@link toSlsAreaAddrDepdntTax} for query construction.
 * Use to reference this property in query operations such as 'select' in the fluent request API.
 */
